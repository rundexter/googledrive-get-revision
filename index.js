var _ = require('lodash'),
    ...
    reqFields = 'id,lastModifyingUser,mimeType,modifiedTime,originalFilename,size';

var pickInputs = {
        'fileId': { key: 'fileId', validate: { req: true } },
        'revisionId': { key: 'revisionId', validate: { req: true } },
    ...
    pickOutputs = {
        ...
        'displayName': 'lastModifyingUser.displayName',
        'emailAddress': 'lastModifyingUser.emailAddress',
